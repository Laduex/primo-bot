...
class SalesReportMessageBuilderTest {
    ...
    void buildsCasualMessageWithTotalsAndWarnings() {
        ...
        assertTrue(!message.contains("12oz Hot Latte (Cafe): `PHP 660.00`"));
        assertTrue(!message.contains("Roasted Tomato & Cheese Bagel (Cafe): `PHP 500.00`"));
    ...
    void rendersOnlyTopTenSkuEntries() {
        ...
        assertTrue(message.contains("UTAK MAIN"));
        assertTrue(message.contains("Total: PHP 10,450.00"));
        assertTrue(message.contains("Top 10 Sold SKU (PHP)"));
        assertTrue(message.contains("10. SKU 10 - PHP 910.00"));
        assertTrue(message.contains("Grand Total: PHP 10,450.00"));
